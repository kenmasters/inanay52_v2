<div id="new-appointment-result_{{$appointment->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
              ...
              {{-- <h1 style="margin-top: 0">{{$appointment->patient->last_name}}, {{$appointment->patient->first_name}}</h1> --}}
                 <table class="table table-condensed">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ isset($appointment->schedule) && $appointment->schedule ? $appointment->schedule->format('M d, Y') : '' }}</td>
                    </tr>
              ...
              <form role="form" action="{{route('appointments.update', $appointment->id)}}" method="post" class="new-appointment">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}

                            <div class="form-group">
                                <label>AOG in Months</label>
                                <input class="form-control" type="text" name="aog_in_months">
                            </div>
                            <div class="form-group">
